...
cargo run --example wallet_management
cargo run --example token_operations
cargo run --example metadata_management
```
...
- One-time signature mechanism (WOTS+) preventing key reuse
...
- 🔄 **Cross-Platform Compatibility**: 100% compatible with JavaScript, Kotlin, PHP, and Python implementations
...
- ⚡ **High Performance**: Native performance for cryptographic operations
...
- **Memory Safety**: Zero-cost abstractions with compile-time guarantees
- **Cryptographic Speed**: Native performance for SHAKE256 operations (~5x faster than JavaScript)
...
- 🐛 Issues: [GitHub Issues](https://github.com/WishKnish/KnishIO-Client-Rust/issues)
...
The Rust SDK maintains 100% compatibility with the JavaScript SDK through comprehensive test vectors. These manually-curated test vectors ensure consistent behavior across platforms.

### Prerequisites

- Rust 1.70 or higher
- Cargo for dependency management
- Required dependencies automatically managed via Cargo
...
git clone https://github.com/WishKnish/KnishIO-Client-Rust.git
cd KnishIO-Client-Rust
...
# Run specific test
cargo test test_shake256_compatibility
...
cargo bench shake256

# Compare with JavaScript SDK performance
cargo bench --bench cross_sdk_performance
```
...
See also the list of [contributors](https://github.com/WishKnish/KnishIO-Client-Rust/contributors) who participated in this project.
