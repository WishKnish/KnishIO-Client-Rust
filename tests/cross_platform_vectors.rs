...
#[test]
#[ignore = "../shared-test-results absent: cross-platform vector suite not compiled in a standalone checkout"]
...
mod cross_platform {
    ...
    // Declared at the file root: a `#[path]` inside this inline module would resolve
    // under tests/cross_platform/.
    use super::fixtures;
